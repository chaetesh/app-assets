...
const desktopModeProps = {
  ...
  "Home": {
    ...
    "Image5": {
      "custom": {
        "alt": "Error!",
        "src": "/app-assets/christina-wocintechchat-com-Jp-X63-an8U-unsplash.jpg"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "TextBox21": {
      "custom": {
        "text": "Web redesign for Consulting X"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "TextBox26": {
      "custom": {
        "text": "I'm Aetesh Chagantipati I'm behind this work. I'm a very passionate and dedicated Developer. "
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image16": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/ux-design%20(1).png"
      },
      "callbacks": {
        "onClick": [
          {
