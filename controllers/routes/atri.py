...
class Atri:
	def __init__(self, state: Any):
		...
		self.Past_proj = state["Past_proj"]
	...
	def Intro(self, new_state):
		...
		global default_state
		self._Intro = Div(new_state, default_state["Intro"])

	@property
	def Past_proj(self):
		self._getter_access_tracker["Past_proj"] = {}
		return self._Past_proj
	@Past_proj.setter
	def Past_proj(self, new_state):
		self._setter_access_tracker["Past_proj"] = {}
		global default_state
		self._Past_proj = Flex(new_state, default_state["Past_proj"])
